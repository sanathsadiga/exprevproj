...
const octData = [
  { location: 'TUMKUR', expense: 13606, revenue: 300000 },
  { location: 'CHIKKA BALLAPUR', expense: 13200, revenue: 0 },
  { location: 'KOLAR', expense: 10445, revenue: 38000 },
  { location: 'RAMANAGAR', expense: 11950, revenue: 0 },
  { location: 'DODDABALLAPUR', expense: 11850, revenue: 73000 },
  { location: 'PUTTUR', expense: 6180, revenue: 0 },
  { location: 'KUNDAPUR', expense: 10900, revenue: 0 },
  { location: 'HAVERI', expense: 11800, revenue: 20000 },
  ...
  { location: 'MADIKERI', expense: 12000, revenue: 0 },
  { location: 'CHAMRAJNAGAR', expense: 10544, revenue: 0 },
  { location: 'HOSPET', expense: 8531, revenue: 0 },
    ...
    for (const data of octData) {
      ...
      try {
        await connection.query(
          ...
          [adminId, locationId, 7, 2025, data.expense, data.revenue, '2024-2025', data.expense, data.revenue]
        );
        insertedCount++;
      } catch (error) {
