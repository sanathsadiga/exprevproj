...
const septData = [
  { location: 'TUMKUR', expense: 15450, revenue: 42600 },
  { location: 'CHIKKA BALLAPUR', expense: 13150, revenue: 0 },
  { location: 'KOLAR', expense: 10445, revenue: 30000 },
  { location: 'RAMANAGAR', expense: 12667, revenue: 0 },
  { location: 'DODDABALLAPUR', expense: 11850, revenue: 0 },
  { location: 'PUTTUR', expense: 6050, revenue: 0 },
  { location: 'KUNDAPUR', expense: 11280, revenue: 0 },
  { location: 'HAVERI', expense: 11949, revenue: 0 },
  { location: 'GADAG', expense: 13874, revenue: 0 },
  { location: 'DHARWAD', expense: 13790, revenue: 0 },
  { location: 'CHITRADURGA', expense: 8920, revenue: 0 },
  { location: 'MANDYA', expense: 13773, revenue: 0 },
  { location: 'MADIKERI', expense: 12000, revenue: 10000 },
  { location: 'CHAMRAJNAGAR', expense: 10544, revenue: 0 },
  { location: 'HOSPET', expense: 8531, revenue: 18000 },
  { location: 'KOPPAL', expense: 9788, revenue: 15000 },
  { location: 'RAICHUR', expense: 12495, revenue: 0 },
  { location: 'CHIKMAGALORE', expense: 12769, revenue: 25000 },
    ...
    for (const data of septData) {
      ...
      try {
        await connection.query(
          ...
          [adminId, locationId, 6, 2025, data.expense, data.revenue, '2024-2025', data.expense, data.revenue]
        );
        insertedCount++;
      } catch (error) {
